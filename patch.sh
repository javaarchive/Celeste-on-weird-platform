...
backup "${celeste_dir}/lib-x86_64"
mkdir -p "${celeste_dir}/lib-x86_64"
...
cp -H otherlibs/fmodstudioapi20206linux/api/studio/lib/x84_64/libfmodstudio.so.13.6 "${celeste_dir}/lib-x86_64/libfmodstudio.so.13.6"
cp -H otherlibs/fmodstudioapi20206linux/api/core/lib/x86_64/libfmod.so.13.6 "${celeste_dir}/lib-x86_64/libfmod.so.13.6"
